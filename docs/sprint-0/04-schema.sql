-- ============================================================================
-- AMIORA — Sprint 0 — Livrable 4 : schéma de données définitif
-- Cible : PostgreSQL 15, dialecte Supabase (schémas auth / storage gérés par
-- la plateforme). Ce script s'exécute tel quel sur un projet Supabase neuf,
-- via l'éditeur SQL ou une migration (supabase db push).
--
